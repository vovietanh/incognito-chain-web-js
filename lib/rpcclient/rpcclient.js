...
import {bytesToString, stringToBytes} from '../privacy/utils';
import {ENCODE_VERSION} from "../constants";
import {CustomError, ErrorObject} from '../errorhandler';
import {PDEPOOLKEY, PRVIDSTR} from "../wallet/constants";
...
class RpcClient {
    ...
    getOutputCoinV2 = async (paymentAdrr, viewingKey, fromBlock, toBlock, tokenID = null) => {
        let data = {
            "jsonrpc": "1.0",
            "method": "listoutputcoinsv2",
            "params": [
                0,
                999999,
                [{
        ...
        return {
            outCoins: response.data.Result.Outputs[viewingKey],
            blockHeight: response.data.Result.CurrentBlockHeights[viewingKey]
        }
    };
