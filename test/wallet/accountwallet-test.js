...
async function TestGetRewardAmount() {
  ...
  let paymentAddressStr = senderKeyWallet.base58CheckSerialize(PaymentAddressType);
  ...
  let response0;
  try {
    response0 = await AccountWallet.getRewardAmount(paymentAddressStr, false, "");
  } catch (e) {
    console.log(e);
  }
